...
public class SupclassVO extends SuperVO {
...
/**
* 属性 pk_supclass的Getter方法.属性名：主键
*  创建日期:2017-10-31
...
/**
* 属性 parent_id的Getter方法.属性名：上级供应商分类
*  创建日期:2017-10-31
...
/**
* 属性parent_id的Setter方法.属性名：上级供应商分类
* 创建日期:2017-10-31
* @param newParent_id nc.vo.train.SupclassVO
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("train.supclass");
    }
   }
